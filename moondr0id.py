...
print("	\033[1;32m ╚══██╔══╝██║░░░██║████╗░████║██║██╔════╝██╔══██╗ 	\033[1;32m ")
print("	\033[1;32m ░░░██║░░░██║░░░██║██╔████╔██║██║╚█████╗░██║░░██║	\033[1;32m ")
print("\033[1;31m                       TumisoRSA Fuck The System  \033[1;31m")
print("	\033[1;32m ░░░██║░░░██║░░░██║██║╚██╔╝██║██║░╚═══██╗██║░░██║	\033[1;32m ")
print("	\033[1;32m ░░░██║░░░╚██████╔╝██║░╚═╝░██║██║██████╔╝╚█████╔╝	\033[1;32m ")
...
def tech_abm():
    ...
    print("")
    print("")
    os.system('echo -e "\t TumisoRSA New Clonning Tool Updated V2.01      "| lolcat')
    print("")
    print("")
    print("")
    print("")
    ...
    print("")
    print("")
    os.system('echo -e "\t×× Welcome to TumisoRSA Updated Tool××       "| lolcat')
    print("")
    print("")
    print("")
    print("")
    ...
    os.system("clear")
    logo()
    os.system('echo -e "[1]××Random login with facebook ID××            "| lolcat')
...
def tech_abm_select():
    ...
    if abm =="1":
        ...
        os.system('echo -e "\t    \033[1;31m××Select Tool4Tool×× "| lolcat')
        tech_abm_select()
def login():
    os.system("clear")
    logo()
    os.system('echo -e "[1] || Login with access token||  "| lolcat')
    os.system('echo -e "[2] ||Login with Email $ Username"| lolcat')
    os.system('echo -e "-----------------------------------------------"| lolcat')
    login_select()
def login_select():
    abm = raw_input("\n╰─➤ ")
...
def b_menu():
    ...
    os.system('echo -e "[2]•|| Clone From Followers ID||•"| lolcat')
...
def b_menu_select():
	...
	if abm =="1":
		...
		os.system('echo -e "-----------------------------------------------"| lolcat')
		idt = raw_input(" Enter ID Number/Username :  ")
		os.system('echo -e "-----------------------------------------------"| lolcat')
		time.sleep(2)
		os.system("clear")
		logo()
	...
	os.system("clear")
	logo()
	os.system('echo -e "Please wait clonned account will Apper Here "| lolcat')
	os.system('echo -e "Dev - TumisoRSA"| lolcat')
	os.system('echo -e "-----------------------------------------------"| lolcat')
	...
	p.map(main, id)
	os.system('echo -e "-----------------------------------------------"| lolcat')
	os.system('echo -e "The Process has been completed sucessfully"| lolcat')
